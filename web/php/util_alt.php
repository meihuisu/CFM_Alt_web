...
function getConnection() {
  $dbconn = @pg_connect("host=db port=5432 dbname=CFM6_alt_db user=webonly password=scec");

  if (!$dbconn) { // try localhost
    $dbconn = pg_connect("host=localhost port=5432 dbname=CFM6_alt_db user=webonly password=scec");
  }
