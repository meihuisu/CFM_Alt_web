...
<button id="dbGo2Btn" class="btn" onclick='updateDBSet();' title="Go to Alternative set" style="color:#395057;background-color:#f2f2f2;border:1px solid #ced4da;border-radius:0.2rem;padding:0.25rem 0.5rem;margin-left:10px;margin-right:10px;"><span>Alt</span></button>
